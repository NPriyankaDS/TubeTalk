...
# Defining three main classes : YouTubeProcessor, DocumentSummariser and QAChatbot
...
# QAChatbot: This is for implementing a chatbot with which the user can interact with in QA format. 
...
class QAChatbot:
    def __init__(self, google_api_key, db_name: str = "qa_database"):
        """
        Initialize the QA Chatbot with a database and embedding function.
